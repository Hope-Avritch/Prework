...
//const patientName = "Skyler Rose"//"Evelyn Park";
//let apptTime = "1600"//"2:30pm";
//let apptDay = "Sartuday"//"Thursday";
...
const firstName = "Hope";//add your first name
const lastName = "Avritch";//add your last name
...
let faveFood = "lobster";//add your favorite food
let faveColor = "green";//add your favorite color
let miniBio = `Hi. I am ${myAge} years old.  My favorite food is ${faveFood}.  My favorite color is ${faveColor}.`; //use string interpolation to create summary that includes your full name, age, favorite food, and favorite color
